...
@Configuration
// 扫描 Mapper 接口并容器管理
@MapperScan(basePackages = MasterDataSourceConfigA.PACKAGE, sqlSessionFactoryRef = "masterSqlSessionFactory")
public class MasterDataSourceConfigA {
    ...
    public SqlSessionFactory masterSqlSessionFactory(@Qualifier("masterDataSource") AtomikosDataSourceBean atomikosDataSourceBean) {
        ...
        try {
            ...
            sessionFactory.setMapperLocations(new PathMatchingResourcePatternResolver()
                    .getResources(MasterDataSourceConfigA.MAPPER_LOCATION));
